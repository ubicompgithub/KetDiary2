...
import com.ubicomp.ketdiary.dialog.AddNoteDialogThinking.EndOnClickListener;
...
public class ReflectionFirstPage implements ChooseItemCaller{
	...
	private LinearLayout center_layout, title_layout, main_layout, bottom_layout, 
						title, date_layout, timeslot_layout, separate_line_layout,
	...
	protected void setting() {
		...
		description_reflection_layout = (LinearLayout) inflater.inflate(
		...
		reflection_title.setTypeface(wordTypefaceBold);
		...
		speech_button = (ImageView) description_reflection_layout.findViewById(R.id.speech_to_text);
		thinking_text = (EditText) description_reflection_layout.findViewById(R.id.edit_thinking_content);
		...
		*/
		...
		View bottom = BarButtonGenerator.createTwoButtonView(R.string.cancel,R.string.next_step, 
				new CancelOnClickListener(), nextOnClickListener);
		...
		main_layout.addView(description_reflection_layout);
		main_layout.addView(discription_layout);
...
//		});
	...
	public void setAllText(String s_date, String s_event,String s_reaction, String s_thinking)
	{
